...
const translations = {
  ru: {
    ...
    nightmareSurvivorAchievement: 'Не оборачивайся',
    nightmareSurvivorAchievementDescription: 'Дойти до конца истории Мистера Блэка',
  ...
  en: {
    ...
    nightmareSurvivorAchievement: 'Do not look back',
    nightmareSurvivorAchievementDescription: 'Reach the end of Mr. Black\'s story',
