...
export const gameDays: readonly GameDay[] = [
  createDay(1, [1, 2, 3, 4, 5, 6], [1, 2, 3, 4, 5, 6]),
  createDay(2, [7, 8, 9, 10, 11, 12], [7, 8, 9, 10, 11, 12]),
  createDay(3, [13, 14, 15, 16, 17, 18], [13, 14, 15, 16, 17, 18]),
  createDay(4, [19, 20, 21, 22, 23, 24], [19, 20, 21, 22, 23, 24]),
  createDay(5, [25, 26, 27, 28, 29, 30], [25, 26, 27, 28, 29, 30]),
  createDay(6, [31, 32, 33, 34, 35, 36], [31, 32, 33, 34, 35, 36]),
  createDay(7, [37, 38, 39, 40, 1, 2], [37, 38, 39, 40, 41, 42]),
];
