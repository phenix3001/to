...
export const gameDays: readonly GameDay[] = [
  createDay(1, [41, 42, 43, 44, 45], [1, 2, 3, 4, 5, 6]),
  createDay(2, [41, 42, 43, 44, 45], [7, 8, 9, 10, 11, 12]),
  createDay(3, [41, 42, 43, 44, 45], [13, 14, 15, 16, 17, 18]),
  createDay(4, [41, 42, 43, 44, 45], [19, 20, 21, 22, 23, 24]),
  createDay(5, [41, 42, 43, 44, 45], [25, 26, 27, 28, 29, 30]),
  createDay(6, [41, 42, 43, 44, 45], [31, 32, 33, 34, 35, 36]),
  createDay(7, [41, 42, 43, 44, 45], [37, 38, 39, 40, 41, 42]),
];
